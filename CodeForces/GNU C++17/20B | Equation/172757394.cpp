...
if(a==0 && b==0 && c==0) cout<<-1;
    ...
    if(a==0 && b==0) cout<<0;
    else if((a==0 && c==0) || (b==0 && c==0) ) cout<<1<<nl<<0;
    else {
        if(a==0) cout<<1<<nl<<(-c)/b;
        else {
if(del<0) cout<<0;
else if(del==0) {cout<<1<<nl<<-(b)/(2*a);}
else {vector<double> v;
v.push_back((((-b)- sqrt(del))/(2*a)));v.push_back((((-b)+ sqrt(del))/(2*a)));
    sort(v.begin(),v.end());
cout<<2<<nl<<v[0]<<nl<<v[1];}
    }
}}}}