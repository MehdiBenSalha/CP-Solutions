...
string somme(string n,int m){
    if (m==0) return n;
    else {string ss="["+n+"]"; return somme(ss,m-1);
}}
...
int fib(int n){
 ...
 else { dp[n]= fib(n-1)+fib(n-2); ready[n]= true;
   return dp[n];}
}
...
cin>>t;
    while (t--) {
string ss="YesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYes";
string s;
cin>>s;
        if(ss.find(s)!=string::npos) cout<<"YES"<<nl;
        else cout<<"NO"<<nl;
