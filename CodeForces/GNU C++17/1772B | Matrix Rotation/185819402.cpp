...
int tab[2][2] ;
        ...
        int cnt=0;
        if(tab[0][0]<tab[0][1] && tab[1][0]<tab[1][1] && tab[0][0]<tab[1][0] && tab[0][1]<tab[1][1] ) cnt++;
        rotate(tab);
        if(tab[0][0]<tab[0][1] && tab[1][0]<tab[1][1] && tab[0][0]<tab[1][0] && tab[0][1]<tab[1][1] ) cnt++;
        rotate(tab);
        if(tab[0][0]<tab[0][1] && tab[1][0]<tab[1][1] && tab[0][0]<tab[1][0] && tab[0][1]<tab[1][1] ) cnt++; rotate(tab);
        if(tab[0][0]<tab[0][1] && tab[1][0]<tab[1][1] && tab[0][0]<tab[1][0] && tab[0][1]<tab[1][1] ) cnt++; rotate(tab);
        if(tab[0][0]<tab[0][1] && tab[1][0]<tab[1][1] && tab[0][0]<tab[1][0] && tab[0][1]<tab[1][1] ) cnt++;
