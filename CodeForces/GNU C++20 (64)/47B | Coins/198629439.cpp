...
string res="";
        bool f= true;
        if(freq1[0]==2) res+='A';
else if(freq1[1]==2) res+='B';
else  if(freq1[2]==2)res+='C';
else f=false;
        if(freq2[0]==2) res+='A';
        else if(freq2[1]==2) res+='B';
        else if (freq2[2]==2)res+='C';
        else f=false;
        if(f) {
            if(res=="AB") res="ACB";
            else if(res=="AC") res="ABC";
            else if(res=="BC") res="BAC";
            else if(res=="BA") res="BCA";
            else if(res=="CA") res="CBA";
            else if(res=="CB") res="CAB";
