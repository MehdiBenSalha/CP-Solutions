...
int solve( vector<int> tab,int n,int even,int odd){itn cnt=0;
    if(even>odd){
        if(tab[0]%2==1){
            for (int i = 1; i < n; ++i) {
                if(tab[i]%2==0){
...
string s;
cin>>s;
string ss="FBFFBFFBFBFFBFFBFBFFBFFBFBFFBFFBFBFFBFFBFBFFBFFBFBFFBFFB";
if(ss.find(s)!=string::npos)cout<<"YES"<<endl;
else cout<<"NO"<<endl;
